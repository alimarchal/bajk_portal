    ...
    <x-slot name="header">
        ...
        <div class="flex justify-center items-center float-right">
            <a href="{{route('download.create')}}" class="flex items-center px-4 py-2 text-gray-600 bg-white border rounded-lg focus:outline-none hover:bg-gray-100 transition-colors duration-200 transform dark:text-gray-200 dark:border-gray-200  dark:hover:bg-gray-700 ml-2" title="Members List">
                ...
                <span class="hidden md:inline-block ml-2">Create New Downloads</span>
            </a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                    ...
                    @endif
                    <form class="w-full mx-auto" action="{{route('download.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                            ...
                            <select id="category_id" name="category_id" class="w-full py-2 px-3 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                @foreach(\App\Models\Category::where('id','=','9')->get() as $cat)
